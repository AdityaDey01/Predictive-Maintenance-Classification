...
response_scoring = requests.post('https://private.au-syd.ml.cloud.ibm.com/ml/v4/deployments/predictivemaintenance/predictions?version=2021-05-01', json=payload_scoring,
